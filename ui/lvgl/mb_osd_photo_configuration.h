...
class OSD_Photo_Configuration : public Remote_Control_Handler, public OSD
{
public:
    typedef std::function<void(bool)> photo_configuration_callback_t;

private:
    photo_configuration_callback_t m_callback;
    ...
    size_t m_slide_show_group = 0;
    size_t m_exibition_time_group = 0;
    size_t m_transition_type_group = 0;
    size_t m_aspect_ratio_group = 0;
    ...
    std::map<Remote_Control_Key, MB_OSD_Enhanced_Keys::KeyCallback> m_title_callbacks = {
        { Remote_Control_Key::KEY_VOLDOWN, std::bind(&OSD_Photo_Configuration::process_voldown_callback, this) },
        { Remote_Control_Key::KEY_VOLUP, std::bind(&OSD_Photo_Configuration::process_volup_callback, this) },
        { Remote_Control_Key::KEY_CHDOWN, std::bind(&OSD_Photo_Configuration::next_callback, this) },
        { Remote_Control_Key::KEY_CHUP, std::bind(&OSD_Photo_Configuration::previous_callback, this) },
        { Remote_Control_Key::KEY_VOLTAR, std::bind(&OSD_Photo_Configuration::voltar_callback, this) },
    };
    ...
    std::map<Remote_Control_Key, MB_OSD_Enhanced_Keys::KeyCallback> m_save_callbacks = {
        ...
        { Remote_Control_Key::KEY_CHDOWN, std::bind(&OSD_Photo_Configuration::next_callback, this) },
        { Remote_Control_Key::KEY_VOLTAR, std::bind(&OSD_Photo_Configuration::voltar_callback, this) },
        { Remote_Control_Key::KEY_OK, std::bind(&OSD_Photo_Configuration::process_save_callback, this) },
    };
...
public:
    OSD_Photo_Configuration(OSD *_parent);
    virtual ~OSD_Photo_Configuration();
    void show_menu_photo_configuration(photo_configuration_callback_t _callback);
};
